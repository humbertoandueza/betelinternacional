...
class PersonaForm(forms.ModelForm):
	...
	class Meta:
		...
		widgets = {
			...
			'iglesia':forms.Select(attrs={'placeholder':'Iglesia a la que Asiste','class':'form-control', 'autocomplete':'off','onkeypress':'return text(event)','onKeyUp':'this.value=this.value.toUpperCase();'}),
			...
			'estudio_teo':forms.Select(attrs={'class':'form-control'}),
